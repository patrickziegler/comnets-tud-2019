...
class HaecController(app_manager.RyuApp):
    ...
    def add_broadcast(self, src, dst, prev, timeout, **kwargs):
        ...
        for d, s in prev.items():
            ...
            next_hop[s].append((d, self.nodes[s].get_links[d].port))
    ...
    def dijkstra(self, source):
        ...
        while queue:
            ...
            for v, e in self.nodes[u].get_links.items():
                alt = dist[u] + e.cost
    ...
    def _packet_in_handler(self, ev):
        ...
        if not dst_node:
            ...
            while c != src_node:
                ...
                out_port = p.get_links[c.name].port
                c = p
...
class HaecRest(ControllerBase):
    ...
    def node_handler(self, req, **kwargs):
        ...
        data = {
            u.decode(): dict(links={v.decode(): e.cost for v, e in n.get_links.items()})
