...
class ConfSwitchAPI(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        mapper.add_link(route_name, uri, controller=controller,
        ...
        s.add_link(route_name, uri, action='delete_switch',
                   conditions=dict(method=['DELETE']))
        s.add_link(route_name, uri, action='list_keys',
                   conditions=dict(method=['GET']))

        uri += '/{key}'
        s.add_link(route_name, uri, action='set_key',
                   conditions=dict(method=['PUT']))
        s.add_link(route_name, uri, action='get_key',
                   conditions=dict(method=['GET']))
        s.add_link(route_name, uri, action='delete_key',
                   conditions=dict(method=['DELETE']))
